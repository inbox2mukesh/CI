!(function (t, e) {
    ...
    var I,
        ...
        Et =
            ...
            (g = {
                ...
                wake: function wake() {
                    o &&
                        (!n && x() && ((h = n = window), (a = h.document || {}), (ot.gsap = Ce), (h.gsapVersions || (h.gsapVersions = [])).push(Ce.version), P(i || h.GreenSockGlobals || (!h.gsap && h) || {}), (m = h.requestAnimationFrame)),
                        p && g.sleep(),
                        (_ =
                            m ||
                            function (t) {
    ...
    var Ut = (function (i) {
        ...
        return (
            ...
            (e.totalTime = function totalTime(t, e) {
                return arguments.length
                    ? ((this._forcing = 1), !this._dp && this._ts && (this._start = ja(Et.time - (0 < this._ts ? t / this._ts : (this.totalDuration() - t) / -this._ts))), i.prototype.totalTime.call(this, t, e), (this._forcing = 0), this)
                    : this._tTime;
            }),
            ...
            (e.getTweensOf = function getTweensOf(e, r) {
                for (var i, n = [], a = Ot(e), s = this._first, o = t(r); s; )
                    s instanceof Gt
                        ? la(s._targets, a) && (o ? (!Vt || (s._initted && s._ts)) && s.globalTime(0) <= r && s.globalTime(s.totalDuration()) > r : !r || s.isActive()) && n.push(s)
        ...
        Xt = function _addPropTween(t, e, i, n, a, o, u, h, l, f) {
            ...
            if ((r(n) && (~n.indexOf("random(") && (n = ob(n)), "=" === n.charAt(1) && ((!(c = ka(p, n) + (Ya(p) || 0)) && 0 !== c) || (n = c))), !f || p !== n || Wt))
                return isNaN(p * n) || "" === n
                    ...
                    : ((c = new pe(this._pt, t, e, +p || 0, n - (p || 0), "boolean" == typeof d ? ae : ne, 0, _)), l && (c.fp = l), u && c.modifier(u, this, t), (this._pt = c));
        },
        Ht = function _initTween(t, e, r) {
            ...
            if (
                ...
                if (((p = (l = R[0] ? fa(R[0]).harness : 0) && m[l.prop]), (i = ua(m, ft)), S && (S._zTime < 0 && S.progress(1), e < 0 && M && y && !C ? S.render(-1, !0) : S.revert(M && A ? ht : ut), (S._lazy = 0)), v)) {
                    if (
                        (za((t._startAt = Gt.set(R, qa({ data: "isStart", overwrite: !1, parent: D, immediateRender: !0, lazy: !S && w(T), startAt: null, delay: 0, onUpdate: b, onUpdateParams: x, callbackScope: k, stagger: 0 }, v)))),
                        (t._startAt._dp = 0),
                        (t._startAt._sat = t),
    ...
    var Gt = (function (z) {
        function Tween(e, r, i, n) {
            ...
            if (((a._targets = C.length ? ea(C) : R("GSAP target " + e + "", !j.nullTargetWarn) || []), (a._ptLookup = []), (a._overwrite = b), x || T || y(_) || y(m))) {
                if (
                    ((r = a.vars),
                    (s = a.timeline = new Ut({ data: "nested", defaults: k || {}, targets: P && "nested" === P.data ? P.vars.targets : C })).kill(),
                    ...
                    if ($(x))
                        ...
                        for (l in u)
                            for (
                                ...
                                ((D = { ease: (S = A[o]).e, duration: ((S.t - (o ? A[o - 1].t : 0)) / 100) * _ })[l] = S.v), s.to(C, D, E), (E += D.duration);
                    ...
                    if (m !== this._tTime || !t || r || (!this._initted && this._tTime) || (this._startAt && this._zTime < 0 != _)) {
                        ...
                        (l && l.render(t < 0 ? t : !i && u ? -V : l._dur * l._ease(i / this._dur), e, r)) || (this._startAt && (this._zTime = t)),
                            ...
                            (m !== this._tDur && m) ||
                                ...
                                e || (_ && !c) || !(m || c || u) || (Ct(this, m === d ? "onComplete" : "onReverseComplete", !0), !this._prom || (m < d && 0 < this.timeScale()) || this._prom()));
                    }
                } else
    ...
    ha(
        ...
        (L = new Ut({ sortChildren: !1, defaults: q, autoRemoveChildren: !0, id: "root", smoothChildTiming: !0 })),
        (j.stringFilter = Eb);
    function Cc(t) {
    ...
    function Md(t, e) {
        var r = Se.createElementNS ? Se.createElementNS((e || "").replace(/^https/, "http"), t) : Se.createElement(t);
    ...
    function Rd(t) {
        var e,
            r = Md("svg", (this.ownerSVGElement && this.ownerSVGElement.getAttribute("xmlns")) || ""),
            i = this.parentNode,
            n = this.nextSibling,
    ...
    function Td(e) {
        ...
        return (r && (r.width || r.height)) || e.getBBox === Rd || (r = Rd.call(e, !0)), !r || r.width || r.x || r.y ? r : { x: +Sd(e, ["x", "cx", "x1"]) || 0, y: +Sd(e, ["y", "cy", "y1"]) || 0, width: 0, height: 0 };
    }
    function Ud(t) {
              ...
              (!_ && "%" !== h) || (!rr[e] && !~e.indexOf("adius"))
                  ? ((l[f ? "width" : "height"] = 100 + (p ? h : i)),
                    ...
                    (s = a._gsap) && _ && s.width && f && s.time === Et.time && !s.uncache
                        ? ia((u / s.width) * 100)
                        : ((!_ && "%" !== h) || _r[Nd(a, "display")] || (l.position = Nd(t, "position")),
    ...
    function je(t, e, r, i, n, a) {
        var s,
            ...
            x = parseFloat(b[1]) || 0;
        r
            ? l !== yr && (o = _ * v - m * g) && ((u = w * (-m / o) + x * (_ / o) - (_ * T - m * y) / o), (w = w * (v / o) + x * (-g / o) + (g * T - v * y) / o), (x = u))
            : ((w = (s = Td(t)).x + (~b[0].indexOf("%") ? (w / 100) * s.width : w)), (x = s.y + (~(b[1] || b[0]).indexOf("%") ? (x / 100) * s.height : x))),
    ...
    function ve(t, e, r) {
        var i,
            ...
            f = r.style;
        for (n in (l.svg
            ? ((a = r.getAttribute("transform")), r.setAttribute("transform", ""), (f[lr] = e), (i = br(r, 1)), Vd(r, lr), r.setAttribute("transform", a))
            : ((a = getComputedStyle(r)[lr]), (f[lr] = e), (i = br(r, 1)), (f[lr] = a)),
        rr))
            (a = l[n]) !== (s = i[n]) &&
                "perspective,force3D,transformOrigin,svgOrigin".indexOf(n) < 0 &&
                ((o = Ya(a) !== (h = Ya(s)) ? Zd(r, n, a, h) : parseFloat(a)), (u = parseFloat(s)), (t._pt = new pe(t._pt, i, n, o, u - o, td)), (t._pt.u = h || 0), t._props.push(n));
        ue(i, l);
    }
    var Ae,
        Se,
        ...
        mr = function _get(t, e, r, i) {
            ...
            return (
                ...
                rr[e] && "transform" !== e
                    ? ((n = br(t, i)), (n = "transformOrigin" !== e ? n[e] : n.svg ? n.origin : wr(Nd(t, fr)) + " " + n.zOrigin + "px"))
                    : ((n = t.style[e]) && "auto" !== n && !i && !~(n + "").indexOf("calc(")) || (n = (vr[e] && vr[e](t, e, r)) || Nd(t, e) || ga(t, e) || ("opacity" === e ? 1 : 0)),
                    ...
                    6 === m.length
                        ...
                        : ((z = m[6]),
                          ...
                          g &&
                              ...
                              (z = C)),
                          (l = (g = ar(-w, R)) * ir),
                          g && ((v = Math.cos(-g)), (E = x * (y = Math.sin(-g)) + E * v), (T = O = T * v - A * y), (b = P = b * v - S * y), (w = C = w * v - R * y)),
                          (u = (g = ar(b, T)) * ir),
                          ...
                          (d = E ? 1 / (E < 0 ? -E : E) : 0)),
                    r.svg && ((O = t.getAttribute("transform")), (r.forceCSS = t.setAttribute("transform", "") || !ge(Nd(t, lr))), O && t.setAttribute("transform", O))),
            ...
            (c = parseFloat(c)),
                ...
                c || d
                    ? ((c *= nr),
                      ...
                      (n = Math.sin(c - d) * -m),
                      (a = Math.cos(c - d) * m),
                      d && ((p *= nr), (s = Math.tan(d - p)), (n *= s = Math.sqrt(1 + s * s)), (a *= s), p && ((s = Math.tan(p)), (r *= s = Math.sqrt(1 + s * s)), (i *= s))),
                      (r = ia(r)),
                      (i = ia(i)),
                      (n = ia(n)),
                      (a = ia(a)))
                    ...
                    if ("autoRound" !== c && ((o = e[c]), !pt[c] || !_b(c, e, i, n, t, a)))
                        if (((l = typeof o), (f = vr[c]), "function" === l && (l = typeof (o = o.call(i, n, t, a))), "string" === l && ~o.indexOf("random(") && (o = ob(o)), f)) f(this, t, c, o, i) && (T = 1);
                            ...
                            if (
                                ...
                                c in hr &&
                                    ("autoAlpha" === c &&
                                        (1 === h && "hidden" === mr(t, "visibility") && u && (h = 0), b.push("visibility", 0, x.visibility), Wd(this, x, "visibility", h ? "inherit" : "hidden", u ? "inherit" : "hidden", !u)),
                                ...
                                if (
                                    (this.styles.save(c),
                                    g ||
                                        (((v = t._gsap).renderTransform && !e.parseTransform) || br(t, e.parseTransform),
                                        (y = !1 !== e.smoothOrigin && v.smooth),
                                        ((g = this._pt = new pe(this._pt, x, lr, 0, 1, v.renderTransform, v, 0, -1)).dep = 1)),
                                    "scale" === c)
                                )
                                    (this._pt = new pe(this._pt, v, "scaleY", v.scaleY, (_ ? ka(v.scaleY, _ + u) : u) - v.scaleY || 0, td)), (this._pt.u = 0), w.push("scaleY", c), (c += "X");
                                else {
