      	...
      	<div class="box box-info">
            <div class="box-header with-border">
              	...
              	<div class="box-tools pull-right">
					...
					?>
                      <a href="<?php echo site_url('adminController/test_preparation_material/index'); ?>" class="btn btn-danger btn-sm">Test preparation material List</a>
				    <?php 
				   }?>
               </div>
            </div>
					...
					<div class="col-md-12">
					   <div>
						...
						<div>
							...
							?>
							 <?php if(!empty($section)){?>
									    <video controls  id="previewVideo<?php echo $i?>" height="400" width="400" class="previewVideo"src="<?php echo site_url(TEST_PREPARATION_VIDEO_PATH.$section);?>"></video>
									 <?php 
									 }else{
									    echo 'no video file';	 
									 ?>
							...
							<?php }else if($section_type=='audio'){
								...
								if(!empty($section)){
								?>
							   <audio controls  id="previewAudio<?php echo $i?>" class="previewAudio" src="<?php echo site_url(TEST_PREPARATION_AUDIO_PATH.$section);?>"></audio>  
								<?php
								}else{
								echo  'no audio file';	
								} 
