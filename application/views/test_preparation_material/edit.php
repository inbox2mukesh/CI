    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
                  ...
                  <a href="<?php echo site_url('adminController/test_preparation_material/index'); ?>" class="btn btn-danger btn-sm">List</a>
               </div>
            </div>
		   ...
		   echo form_open_multipart('adminController/test_preparation_material/edit/'.$free_resources['id'],$attributes);
			...
			?>
          	<div class="box-body">
                    ...
                    <div class="col-md-4">
						...
						<div class="form-group">
							...
							<?php if($free_resources['image']){ ?>
                                <img src="<?php echo site_url(TEST_PREPARATION_IMAGE_PATH.$free_resources['image']);?>"  height="85" width="85" id="thumbnailPreview" class="thumbnailPreview photo-border" style="position:absolute;">
                            <?php }else{ ?>
                                <img src="<?php echo site_url(TEST_PREPARATION_IMAGE_PATH.'no-image.png');?>"  height="85" width="85" id="thumbnailPreview" class="thumbnailPreview photo-border">
                            <?php } ?>
					...
					<div class="col-md-6 margin-bottom-20">
						...
						<div class="form-group">
						<input type="text" name="seo_title" value="<?php echo (isset($seo_title) && !empty($seo_title))?$seo_title:$free_resources['seo_title']; ?>" class="form-control input-ui-100 removeerrmessage" id="seo_title" placeholder="SEO Title"  onpaste="return false" />
					...
					<div class="col-md-12 margin-bottom-20">
						...
						<div class="form-group">
						<textarea name="seo_desc" value="" class="form-control input-ui-100 removeerrmessage" id="seo_desc" placeholder="SEO Description"  onpaste="return false" rows="4" style="resize:none;"><?php echo (isset($seo_desc) && !empty($seo_title))?$seo_title:$free_resources['seo_desc']; ?></textarea>
							...
							<div class="col-md-12 employeeTierDiv sec-bg" id="employeeTierDiv-<?php echo $i?>">
								...
								<div class="col-md-8">
								   ...
								   <div class="col-md-6">
								     ...
								     <img src="<?php echo site_url(TEST_PREPARATION_IMAGE_PATH.$old_section);?>" height="150" width="150" id="previewImg<?php echo $i?>" class="previewImg">
									 <?php 
									 }else{?>
								  ...
								  <div class="col-md-6">
					              <input type="file" id="free_resources_section<?php echo $i?>" name="free_resources_section<?php echo $i?>" class="form-control free_resources_section" value="<?php echo site_url(TEST_PREPARATION_IMAGE_PATH.$old_section);?>" onchange="isImage('<?php echo $i?>')"/>[Allowed: jpg, png,jpeg]
								  <span class="text-danger free_resources_section<?php echo $i?>_err"></span>
								  <input  type="hidden" id="old_free_resources_section<?php echo $i?>" value="<?php echo site_url(TEST_PREPARATION_IMAGE_PATH.$old_section);?>"/>  
								</div>
                                   </div>
									<?php 
                                   ...
                                   <div > 
								    ...
								    <div class="col-md-6">
									  <?php if(!empty($old_section)){?>
									    <video controls  id="previewVideo<?php echo $i?>" height="150" width="150" class="previewVideo"src="<?php echo site_url(TEST_PREPARATION_VIDEO_PATH.$old_section);?>"></video>
								   ...
								   <div class="col-md-6">
										...
										<span class="text-danger free_resources_section<?php echo $i?>_err"></span>
										<input  type="hidden" id="old_free_resources_section<?php echo $i?>" value="<?php echo site_url(TEST_PREPARATION_VIDEO_PATH.$old_section);?>"/>
                                </div>
								</div>
								<?php
								...
								<div class="col-md-6">
								  ...
								  <span class="text-danger free_resources_section<?php echo $i?>_err"></span> 
								  <input type="hidden" id="old_free_resources_section<?php echo $i?>" value="<?php echo site_url(TEST_PREPARATION_AUDIO_PATH.$old_section);?>"/>  
								</div>
								</div>
                                 <?php		
								}?>
...
<script>
    ...
    function deletefreeResourcesTestType(free_resources_id,test_module_id){
        $.ajax({
            url: "<?php echo site_url('adminController/test_preparation_material/ajax_delete_free_resources_test');?>",
            async : true,
            type: 'post',
