<div class="row">
    ...
    <div class="box box-flex-widget">
            <div class="box-header bg-danger">
                ...
                <div class="box-tools">
                    <?php 
                        if($this->Role_model->_has_access_('source_master','add')){
                    ?>
                    <a href="<?php echo site_url('adminController/source_master/add'); ?>" class="btn btn-danger btn-sm">Add</a> <?php } ?>
                </div>
            </div>
            ...
            <div class="col-md-12">
                ...
                <table class="table table-striped table-bordered table-sm">
                    ...
                    <tbody id="myTable">
                        ...
                        foreach ($source_master as $p) {
                            $zero = 0;
                            $one = 1;
                            $pk = 'id';
                            $table = 'source_masters';
                            $sr++; ?>
                            <tr>
                                <td><?php echo $sr; ?></td>
                                <td><?php echo $p['source_name']; ?></td>
                                <td><?php echo !empty($p['is_static']) ? 'Yes':'No'; ?></td>
                                <td>
                                    <?php
                                    if ($p['active'] == 1) {
                                ...
                                <td>
                                    <?php 
                                     if($this->Role_model->_has_access_('source_master','edit') && empty($p['is_static'])){
                                    ?>
