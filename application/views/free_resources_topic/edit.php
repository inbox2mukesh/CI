<div class="row">
    <div class="col-md-12">
      	<div class="box box-info">
			...
			<?php echo form_open('adminController/free_resources_topic/edit/'.$topic_master['topic_id']); ?>
			<div class="box-body">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="topic" value="<?php echo ($this->input->post('topic') ? $this->input->post('topic') : $topic_master['topic']); ?>" class="form-control input-ui-100" id="topic" maxlength="20" onblur="check_freeresourcetopic_duplicacy(this.value);"/>
