    ...
    <div class="box box-flex-widget">
            <div class="box-header bg-danger">
                ...
                <div class="box-tools">
                    ...
                    ?>
                    <a href="<?php echo site_url('adminController/classroom_announcement/add'); ?>" class="btn btn-danger btn-sm">Add</a> 
                   <?php }?>
                   <?php 
                    if($this->Role_model->_has_access_('classroom_announcement','index')){
                    ?>
                    <a href="<?php echo site_url('adminController/classroom_announcement/index'); ?>" class="btn btn-success btn-sm">ALL Announcements</a>
                    <?php }?>
                </div> 
            </div>
...
foreach($announcements as $l){$zero=0;$one=1;$pk='id'; $table='announcements';$sr++; ?>
                    <tr>
                        <td><?php echo $sr; ?></td>
						...
						<td>
                            ...
                            ?>
                            <a href="<?php echo site_url('adminController/classroom_announcement/edit/'.$l['id']); ?>" class="btn btn-info btn-xs" data-toggle="tooltip" title="Edit"><span class="fa fa-pencil"></span> </a>
                            <?php }?>                            
                        </td>
                    </tr>
                    <?php } ?>
