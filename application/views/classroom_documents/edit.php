...
<script>
	...
	function deleteClassroomDocumentsClass(classroom_documents_id,classroom_id){
        $.ajax({
            ...
            async : true,
            type: 'post',
            data: {classroom_documents_id:classroom_documents_id, classroom_id:classroom_id},
            dataType: 'json',
	...
	function deleteClassroomDocumentsContentType(classroom_documents_id,content_type_id){
        $.ajax({
            ...
            async : true,
            type: 'post',
            data: {classroom_documents_id:classroom_documents_id, content_type_id:content_type_id},
            dataType: 'json',
            success: function(response){
                if(response==1){
                    window.location.href=window.location.href
