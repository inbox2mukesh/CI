<div class="row">
    <div class="col-md-12">
      	<div class="box box-info">
			...
			<?php echo form_open('adminController/test_module/edit/'.$test_module['test_module_id']); ?>
			<div class="box-body">
				
					<input type="hidden" name="test_module_id_hidden" id="test_module_id_hidden" value="<?php echo $test_module['test_module_id'];?>">
					<div class="col-md-6">
						<label for="test_module_name" class="control-label"><span class="text-danger">*</span>Course Name</label>
						<div class="form-group">
							<input type="text" name="test_module_name" value="<?php echo ($this->input->post('test_module_name') ? $this->input->post('test_module_name') : $test_module['test_module_name']); ?>" class="form-control input-ui-100" id="test_module_name"  onblur="check_course_name_duplicacy(this.value);"/>
