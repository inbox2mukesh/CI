			...
			<div class="box-body">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="course_timing" value="<?php echo ($this->input->post('course_timing') ? $this->input->post('course_timing') : $course_type['course_timing']); ?>" class="form-control input-ui-100" id="course_timing" maxlength="20" onblur="check_course_type_duplicacy(this.value);"/>
