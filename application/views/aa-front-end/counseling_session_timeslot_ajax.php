...
if(count($SESSION_TIMESLOT_URL->error_message->data) == 1)
{
$op_sel="checked";
}
else {
...
?>
        <div class="col-md-3 col-sm-3">
            <div class="time-card">
                <div class="time-slot">
                    <input type="radio" class="cs_bookingtime" id="radio<?php echo $key; ?>" name="cs_timeslot" value="<?php echo $p->time_slot ?>" onclick="getFinalSession(this.value)" <?php echo $op_sel;?>>
