...
<div class="news-articles">
	<h3><i class="fa fa-thumb-tack"></i> Pinned Articles</h3>
		<ul>
			...
			?>
			<li><a href="<?php echo base_url('news/post/'.$d->URLslug);?>"><?php echo $d->title;?><p><?php echo $news_date;?></p></a></li>
		<?php } ?>
		</ul>
</div>
	...
	<ul>
		<?php foreach ($newsTag->error_message->data as $d){ ?>
			<li><a href="<?php echo base_url('news/'.base64_encode($d->tags));?>"><?php echo $d->tags;?></a></li>
		<?php } ?>	
	</ul>
	</div>
</div>