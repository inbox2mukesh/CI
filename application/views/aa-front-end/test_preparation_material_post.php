      ...
      <div class="col-md-4">
        <div class="rt-sidebar mob-display">
          <div class="news-articles">
            <h3>More Test Material</h3>
            <ul>
              <?php
              if(count($TEST_PREPARATION_SECTION_LIMITED->error_message->data) >0)
              {
                foreach ($TEST_PREPARATION_SECTION_LIMITED->error_message->data as $p) { ?>
                  <li><a href="<?php echo base_url() ?>test-preparation-material/post/<?php echo $p->URLslug; ?>"><?php echo ucfirst($p->title); ?><p><?php echo $p->created; ?></p></a></li>
                <?php } ?>  
              <?php 
              }
              else {
