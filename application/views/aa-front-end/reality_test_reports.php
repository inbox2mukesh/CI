        ...
        <div class="content-aside dash-main-box">
					...
					<div class="row">
						<div class="global-page-scroll" id="scroll-style">
							<?php if(count($RT_reports->error_message->data)>0){ 
      		foreach($RT_reports->error_message->data as $p){        
  		?>
							<div class="col-md-6">
								<div class="rlty-test-report-box mt-5">
									<div class="info">
										...
										<div class="ftr-btm"> <a href="<?php echo base_url('our_students/reality_test_reports_download/'.$p->id.'/'.$p->test_module_name);?>" target="_blank" class="btn btn-wht mt-5">Download Report</a> </div>
									</div>
								</div>
							</div>
						<?php }} else { ?>
							<div class="col-md-6">
								<div><span class="font-weight-600 mr-5"> No Reality test report is available now!</div>
							</div>
							<?php	} ?>					
						</div>
					</div>
