            ...
            <div class="col-md-12 table-ui-scroller">
                ...
                <table class="table table-striped table-bordered table-sm">
                    ...
                    <?php if(!empty($this->input->get('per_page'))) {
                        ...
                        foreach($report as $t){ $zero=0;$one=1;$pk='id'; $table='mock_test_report_ielts';$sr++; ?>
                    <tr> 
                    <td class='noPrint'>
                            <?php
                                if($this->Role_model->_has_access_('mock_test','edit_ielts_report_')){
                            ?>
                            <a href="<?php echo site_url('adminController/mock_test/edit_ielts_report_/'.$t['id']); ?>" class="btn btn-info btn-xs" data-toggle="tooltip" title="Edit Report"><span class="fa fa-pencil"></span></a><?php } ?>
                        </td>
                        <td><?php echo $sr; ?></td>
                        <td><?php echo $t['Test_Type'];?></td>
                        <td><?php echo $t['Centre_Number'];?></td>
                        <td><?php echo $t['Candidate_Number'];?></td> 
                        <td><?php echo $t['Candidate_ID'];?></td>
