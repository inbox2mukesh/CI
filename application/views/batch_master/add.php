          	...
          	<div class="box-body">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="batch_name" value="<?php echo $this->input->post('batch_name'); ?>" class="form-control input-ui-100" id="batch_name" maxlength="20" onblur="check_batch_duplicacy(this.value);"/>
