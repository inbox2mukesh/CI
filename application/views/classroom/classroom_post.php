    ...
    <div class="box box-flex-widget">
            ...
            <div class="table-ui-scroller">
                <div class="box-body table-responsive table-cb-none mheight200" id="printableArea">
                    ...
                    <tbody id="myTable">
                    <?php $sr=0;foreach($classroom_post as $s){$zero=0;$one=1;$pk='post_id'; $table='student_class_posts';$sr++; ?>
                    <tr>
						<td><?php echo $sr; ?></td>                        
						...
						<td>
                            <?php 
                            if($s['active']==1){
                                echo '<span class="text-success"><a href="javascript:void(0);" id='.$s['post_id'].' data-toggle="tooltip" title="Active" >'.ACTIVE.'</a></span>';
                            }else{
                                echo '<span class="text-danger"><a href="javascript:void(0);" id='.$s['post_id'].' data-toggle="tooltip" title="De-Active" >'.DEACTIVE.'</a></span>';
                            }
                            ?>                                
                        </td>  
