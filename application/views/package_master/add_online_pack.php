          	...
          	<div class="box-body">
          		<div class="clearfix flex-auto">
					...
					<div class="col-md-4 media-file-widget">
						...
						<div class="form-group">
							<input type="file" name="image" class="form-control input-file-ui-100 input-file-ui" id="image" value="<?php echo $this->input->post('image'); ?>" onchange="validate_file_type_Webp(this.id)" />
