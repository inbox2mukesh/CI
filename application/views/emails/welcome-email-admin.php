...
<tr>
	...
	<p style="word-break:break-word;"> 	<?php echo $email_message.'<br/><br/>'; ?>
...
<tr>
	<td align="right">	
		<a href="<?php echo base_url('adminController/login');?>" style="background-color: #131945;border: none;color: white;padding: 10px 15px;text-align: center;text-decoration: none;display: inline-block;font-size: 15px;border-radius: 4px;">LOGIN</a>	
	</td>
</tr>
</table>
<!--footer-->
