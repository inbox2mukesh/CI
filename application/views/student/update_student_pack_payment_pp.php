<div class="student-update_student_pack_payment_pp">
	<div class="row">
		<div class="col-md-12">
			<div class="box box-info">
				<div class="box-header with-border">
					...
					<div class="box-tools pull-right">
						<?php foreach ($student_package_pp as $sp) { ?>
							<a href="<?php echo site_url('adminController/student/student_full_details_/' . base64_encode($sp['student_id'])) ?>" class="btn btn-success btn-sm">See Student Details</a>
							<a href="<?php echo site_url('adminController/student/edit/' . base64_encode($sp['student_id'])) ?>" class="btn btn-warning btn-sm">Manage Student</a>
						<?php } ?>
					</div>
				</div>
				...
				<div class="box-body">
					<div class="clearfix">
						...
						<?php 
							foreach ($student_package_pp as $sp) { 
								...
								$_SESSION['current_start_date']=$sp['subscribed_on2'];
								
								//echo $holdDateFrom_isFuture;
						?>
							<?php echo form_open_multipart('adminController/student/adjust_practice_pack_/' . $sp['student_package_id'], array('onsubmit' => 'return validate_adjustment_forms();')); ?>
							...
							<div class="col-md-3">
								<label for="test_module_name" class="control-label">Course</label>
								<div class="form-group has-feedback">
						...
						?>">
							<div class="col-md-3">
								...
								<div class="form-group has-feedback">
									<input type="text" name="amount_due" value="<?php echo $sp['amount_due']; ?>" class="form-control input-ui-100" id="amount_due" disabled />
									<span class="form-control-feedback"><i class="fa fa-usd"></i></span>
								</div>
							</div>
							...
							<div class="col-md-3">
								<label for="amount_refund" class="control-label text-danger">Wallet Refund</label>
								<div class="form-group has-feedback">
							...
							<div class="col-md-3">
								...
								<div class="form-group has-feedback">
									...
									<span class="form-control-feedback"><i class="fa fa-percent"></i></span>
								</div>
							</div>
							...
							<div class="col-md-3">
								...
								<div class="form-group has-feedback">
									<input type="text" name="expired_on1" value="<?php echo $sp['expired_on2']; ?>" class="form-control input-ui-100" id="expired_on1" disabled data-date="<?php $datee = date_create($sp['expired_on2']); echo date_format($datee, "d-m-Y"); ?>" data-strdate="<?php $dateex = date_create($sp['expired_on2']); echo strtotime(date_format($dateex, "d-m-Y")); ?>" />
									<span class="glyphicon glyphicon-calendar form-control-feedback"></span>
								</div>
							</div>
							...
							<div class="col-md-12">
								...
								<div class="form-group">
									...
									?>
										<a href='<?php echo site_url(PAYMENT_SCREENSHOT_FILE_PATH_PP . $sp['payment_file']); ?>' target="_blank"><img src='<?php echo site_url(PAYMENT_SCREENSHOT_FILE_PATH_PP . $sp['payment_file']); ?>' class="img-brdr"></a>

									<?php } elseif (isset($sp['payment_file']) and ($ext == 'pdf')) { ?>

										<a href='<?php echo site_url(PAYMENT_SCREENSHOT_FILE_PATH_PP . $sp['payment_file']); ?>' target="_blank"><?php echo OPEN_FILE; ?></a>
									<?php } else { ?>
										<?php echo NO_FILE; ?>
									<?php } ?>
								</div>
							...
							<?php if ($sp['packCloseReason'] == 'Course switched' or $sp['packCloseReason'] == 'Full Refund') { ?>

							<?php } elseif ($sp['packCloseReason'] == 'Pack Terminated') { ?>
								<div class="col-md-12">
						...
						<div class="col-md-12 course_switch_form" style="display: none;">
							...
							<div class="row">
								...
								<div class="col-md-4">
									...
									<div class="form-group has-feedback">
										<input type="text" name="add_payment_cs" placeholder="Enter Cutting amount" class="form-control input-ui-100" id="add_payment_cs" maxlength="5"/>
										<span class="form-control-feedback"><i class="fa fa-usd"></i></span>
					...
					<!--waiver-->
					<div class="col-md-12 mns-mt-10 form-group"><span class='text-danger waiver_msg_failed'></span></div>

					<div class="col-md-12 mns-mt-10 table-responsive wv_table" style="display: none;">
						<table class="table table-striped table-bordered table-sm">
							...
							<tbody id="myTable">
								<tr>
									...
									<td id="wremarks"></td>
									<td id="wapprover"></td>
									<td> <a href="javascript:void(0);" class="btn btn-info btn-xs" data-toggle="tooltip" title="Use Waiver" onclick="remburse_waiver();" id="waiver_btn"><span class="fa fa-plus"></span> </a> </td>
								</tr>
							</tbody>
						</table>
					</div>
						...
						<div class="row">
							...
							<div class="col-md-4">
								<div class="form-group has-feedback">
									...
									<input type="text" name="holdDateFrom" class="DateVariryBetweenStartEnd form-control input-ui-100" id="holdDateFrom" maxlength="10" readonly="readonly" />
							...
							<div class="col-md-4">
								<div class="form-group has-feedback">
									...
									<input type="text" name="holdDateTo" class="DateVariryBetweenStartEnd_holdenddate form-control input-ui-100" id="holdDateTo" maxlength="10" readonly="readonly" />
					...
					<div class="col-md-12 terminate_pack_form" style="display: none;">
						...
						<div class="form-group has-feedback">
							...
							<textarea name="termination_reason" class="form-control" placeholder="Add termination reason" id="termination_reason" onkeyup="getWordCount_tr(this.value);" onkeypress="getWordCount_tr(this.value);" onblur="getWordCount_tr(this.value);"><?php echo $this->input->post('termination_reason'); ?></textarea>
							<span class="glyphicon glyphicon-text-size form-control-feedback"></span>
					...
					<div class="col-md-12 due_commitment_form" style="display: none;">
						<div class="form-group has-feedback">
							...
							<input type="text" name="new_due_committment_date" value="<?php echo ($this->input->post('new_due_committment_date') ? $this->input->post('new_due_committment_date') : ''); ?>" class="DateVariryBetweendueplusfive_days_holdenddate form-control input-ui-100 removeerrmessage" id="new_due_committment_date" autocomplete="off"  readonly="readonly" />
							<span class="glyphicon glyphicon-calendar form-control-feedback"></span>
	...
	<script>
	  ...
	  $(".DateVariryBetweendueplusfive_days_holdenddate").datepicker("destroy");
