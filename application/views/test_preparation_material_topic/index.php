<div class="row">
    ...
    <div class="box box-flex-widget">
           <div class="box-header bg-danger">
            	...
            	<div class="box-tools">
                    <?php 
                        if($this->Role_model->_has_access_('test_preparation_material_topic','add')){
                    ?>
                    <a href="<?php echo site_url('adminController/test_preparation_material_topic/add'); ?>" class="btn btn-danger btn-sm">Add</a> <?php } ?>
                </div>                
            </div>
                ...
                <table class="table table-striped table-bordered table-sm">
                   ...
                   foreach($topic_master as $p){ $zero=0;$one=1;$pk='topic_id'; $table='free_resources_topic';$sr++; ?>
                    <tr>
						...
						<td>
                            <?php 
                                if($this->Role_model->_has_access_('test_preparation_material_topic','edit')){
                            ?>
                            <a href="<?php echo site_url('adminController/test_preparation_material_topic/edit/'.$p['topic_id']); ?>" class="btn btn-info btn-xs" data-toggle="tooltip" title="Edit"><span class="fa fa-pencil"></span> </a> 
                            <?php } ?>
