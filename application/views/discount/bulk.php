...
<div class="row">
    <div class="col-md-12">
      	<div class="box box-info">
            ...
            <?php echo form_open('adminController/discount/bulk'); ?>
          	<div class="box-body">
				...
				<input type="text" name="txtSearch" value="<?php echo $this->input->post('txtSearch'); ?>" placeholder="discount name" class="form-control input-ui-100" id="txtSearch"  />
						</div>
					</div>
			...
			<div class="col-md-4">
					...
					<div class="col-md-4">
						...
						<div class="form-group has-feedback">
							<input type="text" name="start_date" value="<?php echo $this->input->post('start_date'); ?>" autocomplete="off" class="has-datepicker form-control  input-ui-100 disbled" id="start_date" /><span class="glyphicon glyphicon-calendar form-control-feedback"></span>
						</div>
					</div>
					...
					<div class="col-md-4">
						...
						<div class="form-group has-feedback">
							<input type="text" name="end_date" value="<?php echo $this->input->post('end_date'); ?>" autocomplete="off" class="has-datepicker form-control disbled input-ui-100" id="end_date" /><span class="glyphicon glyphicon-calendar form-control-feedback"></span>
						</div>
					</div>	
					<?php 
						$today = date('d-m-Y');
            ...
            <div class="box-body table-responsive">
                <table class="table table-striped table-bordered table-sm">
                    ...
                    <tr>
                       ...
                       <?php /*?> <td><?php echo $c->discount_code; ?></td><?php */?>
                        <td nowrap="nowrap">
                             <?php 
                        ...
                        <td nowrap>
                         <a href="javascript:void(0)" class="btn btn-primary btn-xs"  data-toggle="modal" data-target="#modal-viewDiscount" onclick="getDiscountDetails(this.id);" id="<?php echo $c->id;?>" title="Full Details"><span class="fa fa-eye"></span> </a>
							 ...
							 if($endtime>$currenttime) {?>
                           <a href="javascript:void(0)" class="btn btn-primary btn-xs"  data-toggle="modal" data-target="#modal-addbulkMore" onclick="getAddMoreCode(this.id);" id="<?php echo $c->id;?>" title="Add more codes"><span class="fa fa-plus"></span> </a>
                           <?php }?>
                        </td>
...
<div class="modal fade" id="modal-viewDiscount" style="display: none;">
        ...
        <div class="modal fade" id="modal-addbulkMore" style="display: none;">
          <div class="modal-dialog" style="width:1000px !important;">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close" >
