...
<div class="discount_indexWidget">    
...
<div class="row">
    <div class="col-md-12">
      	<div class="box box-info">
            ...
            <?php echo form_open('adminController/discount/index'); ?>
          	<div class="box-body">
				...
				<input type="text" name="txtSearch" value="<?php echo $this->input->post('txtSearch'); ?>" placeholder="discount name / discount code" class="form-control input-ui-100 " id="txtSearch"  />
						</div>
					</div>
 	...
 	<div class="row clearfix">
            <div class="col-md-4">
			        ...
			        <div class="col-md-4">
						...
						<div class="form-group">
                            <?php
                                if($this->input->post('appliedPackages')){
                            ?>
					...
					<div class="col-md-4">
						...
						<div class="form-group has-feedback">
							<input type="text" name="start_date" value="<?php echo $this->input->post('start_date'); ?>" autocomplete="off" class="has-datepicker form-control disbled input-ui-100" id="start_date" /><span class="glyphicon glyphicon-calendar form-control-feedback"></span>
						</div>
					</div>
                ...
                <table class="table table-striped table-bordered table-sm">
                    ...
                    <?php $json = json_decode($discount);
					 if(!empty($this->input->get('per_page'))) {
                        ...
                        foreach($json as $c){ $zero=0;$one=1;$pk='id'; $table='discount';$sr++; ?>                    
                    <tr>
						<td><?php echo $sr; ?></td>
                        ...
                        <td><?php echo $c->discount_code; ?></td>
                        <td nowrap="nowrap">
                             <?php 
...
// 	$(function() {
//     $("body").delegate(".noBackDate", "focusin", function(){
//         $(this).datepicker({ 
// 	format: 'dd-mm-yyyy',
// 	startDate : start,
//     endDate   : end,
