<div class="row">
    <div class="col-md-12">
      	<div class="box box-info">
			...
			<?php echo form_open('adminController/video/edit/'.$video['video_id']); ?>
			<div class="box-body box-body table-cb-none">
				<div class="">
					...
					<div class="col-md-6">
						...
						<div class="form-group has-feedback">
							<input type="text" name="video_url" value="<?php echo ($this->input->post('video_url') ? $this->input->post('video_url') : $video['video_url']); ?>" class="form-control input-ui-100" id="video_url"   onblur="ValidURL(this.value,this.id),validate_video_url_mp4(this.id)" />
					...
					<div class="col-md-12">
						<div class="form-group form-checkbox">
							<input type="checkbox" name="active" value="1" <?php echo ($video['active']==1 ? 'checked="checked"' : ''); ?> id='active' />
