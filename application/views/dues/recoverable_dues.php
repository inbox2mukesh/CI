<div class="row">
    <div class="col-md-12">
      	<div class="box box-info">
            ...
            <?php echo form_open('adminController/dues/recoverable_dues'); ?>
          	<div class="box-body">
          		<div class="clearfix">
					<?php //print_r($this->input->post('center_id'));?>
          			<div class="col-md-3">
						...
						<div class="form-group">
							<select name="center_id[]" id="center_id" class="form-control selectpicker selectpicker-ui-100" data-show-subtext="true" data-live-search="true" data-actions-box="true" multiple="multiple">
								...
								<?php 
								foreach($all_branch as $k=>$b){
									//$selected = ($b['center_id'] == $this->input->post('center_id')[$k]) ? ' selected="selected"' : "";
					...
					<div class="col-md-3">
						...
						<div class="form-group">
							<select name="test_module_id[]" id="test_module_id" class="form-control selectpicker selectpicker-ui-100" data-show-subtext="true" data-live-search="true"  data-actions-box="true" multiple="multiple" onchange="reflectPgmBatch(this.value,'recoverable_dues');">
						...
						<div class="form-group">
							<select name="programe_id[]" id="programe_id" class="form-control selectpicker selectpicker-ui-100" data-show-subtext="true" data-live-search="true" data-actions-box="true" multiple="multiple">
								...
								//	$selected = ($programe_master['programe_id'] == $this->input->post('programe_id')) ? ' selected="selected"' : "";
									...
									if (in_array($programe_master['programe_id'], $this->input->post('programe_id')))
									{
										$selected ="selected";
									}
									else {
					...
					<div class="form-group" style="margin-bottom:10px">
							...
							<label for="committmentDate" class="control-label mr-15">Commitment Date </label>

							<input type="radio" name="dateType" id="sellingDate" value='2' class='byDate' <?php echo $checked2;?> />
							<label for="sellingDate" class="control-label">Selling Date</label>
					...
					?>
					<!-- <div class="col-md-12">
						<a href="<?php echo base_url('adminController/dues/recoverable_dues/'.$yesterday);?>"><input type="button" name="yesterday" value="Yesterday"></a> &nbsp;

						<a href="<?php echo base_url('adminController/dues/recoverable_dues/'.$today);?>"><input type="button" name="today" value="Today"></a> &nbsp;

						<a href="<?php echo base_url('adminController/dues/recoverable_dues/'.$tomarrow);?>"><input type="button" name="tomarrow" value="Tomarrow"></a> &nbsp;
					</div> -->	

					<div class="col-md-12">
						<input type="button" name="yesterday"  class="date_btn <?php if($yesterday == $this->input->post('date_to')){?>tb-active<?php } ?>"  value="Yesterday" onclick="fillCalendar('<?php echo $yesterday;?>')"> &nbsp;
            ...
            <div class="box-header bg-danger">
                ...
                <table class="table table-striped table-bordered table-sm">
                    ...
                    <?php
                        ...
                        if(count($duesData)>0){
                        foreach($duesData as $sp){$zero=0;$one=1;$pk='student_package_id'; $table='student_package';$sr++;
                        $totalAmountDue +=  $sp['amount_due']/100;     
                    ?>                     
                    <tr>
						<td><?php echo $sr; ?></td>                        
						...
						<td><?php echo CURRENCY.' '.($sp['amount_due']/100).'/-'; ?></td>
						<td><?php echo date('M d, Y', $sp['due_commitment_date']);?></td>		
