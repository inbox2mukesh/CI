          	...
          	<div class="box-body">
          		...
          		<div class="col-sm-4">
                    <div class="form-group enqForm">
                      <input name="fname" id="fname" class="form-control input-ui-100" type="text" placeholder="First Name*" aria-required="true" value="" maxlength="30" >
                ...
                <div class="col-sm-4">
                    <div class="form-group enqForm">
                      <input name="lname" id="lname" class="form-control input-ui-100" type="text" placeholder="Last Name" aria-required="true" value="" maxlength="30">
                  ...
                  <div class="col-sm-12 enqForm">
                    <div class="form-group">
                      <textarea name="message" id="message" class="form-control required" placeholder="Enter Message* (Max. 150 words)" rows="5" aria-required="true" ></textarea>
