...
define('GET_VISA_BANNER_URL', 'WOSA-API-V1/Get_all_visa_banner');
...
define('FOURMODULE_IELTS_ACD_INDIAN', '336');
define('FOURMODULE_IELTS_GT_INDIAN', '338');
define('FOURMODULE_CD_IELTS_ACD_INDIAN', '336');
define('FOURMODULE_CD_IELTS_GT_INDIAN', '338');
define('FOURMODULE_PTE_INDIAN', '344');
define('FOURMODULE_CELPIP_INDIAN', '5');
define('FOURMODULE_FLIP_INDIAN', '187');
define('FOURMODULE_CAEL_INDIAN', '44');
define('FOURMODULE_TOEFL_INDIAN', '252');

define('FOURMODULE_IELTS_ACD_INTERNATIONAL', '337');
define('FOURMODULE_IELTS_GT_INTERNATIONAL', '339');
define('FOURMODULE_CD_IELTS_ACD_INTERNATIONAL', '337');
define('FOURMODULE_CD_IELTS_GT_INTERNATIONAL', '339');
define('FOURMODULE_PTE_INTERNATIONAL', '345');
define('FOURMODULE_CELPIP_INTERNATIONAL', '302');
define('FOURMODULE_FLIP_INTERNATIONAL', '');
define('FOURMODULE_CAEL_INTERNATIONAL', '346');
define('FOURMODULE_TOEFL_INTERNATIONAL', '317');
