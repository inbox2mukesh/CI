...
class Get_all_pp_pack_long_count extends REST_Controller {  
    ...
    */
    ...
    { 
        if(!$this->Authenticate($this->input->get_request_header('API-KEY'))) {            
          ...
          $data = $this->Practice_package_model->get_all_package_active_count($country_id,$test_module_id,$programe_id,$duration,$limit,$offset,$category_id);
