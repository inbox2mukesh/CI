...
class Get_shared_doc_filter_count extends REST_Controller {  
    ...
    { 
        if(!$this->Authenticate($this->input->get_request_header('API-KEY'))) {            
          ...
          $searchtext = $this->input->get_request_header('SEARCH-TEXT'); 
          $limit = $this->input->get_request_header('LIMIT');
          $offset = $this->input->get_request_header('OFFSET');    
          $data = $this->Classroom_documents_modal->getCLDocsId_CTYPE_count($contenttype_id,$classroom_id,$searchtext,$limit,$offset);
          //$aData = $this->Classroom_documents_modal->getClassroomDocsID($classroom_id);
