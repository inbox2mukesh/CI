...
class Get_shared_doc_filter extends REST_Controller {  
    ...
    { 
        if(!$this->Authenticate($this->input->get_request_header('API-KEY'))) {            
          ...
          $aData = $this->Classroom_documents_modal->getCLDocsId_CTYPE($contenttype_id,$classroom_id,$searchtext,$limit,$offset);
