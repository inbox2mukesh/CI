...
class Get_class_schedule_long extends REST_Controller {  
    ...
    */
    ...
    { 
        if(!$this->Authenticate($this->input->get_request_header('API-KEY'))) {            
          ...
          $bData = $this->Online_class_schedule_model->get_weekly_schedule_all($current_DateTimeStr_after,$classroom_id,$limit,$offset,$classname,$type,$filterclassdater);
          if(!empty($bData)){
