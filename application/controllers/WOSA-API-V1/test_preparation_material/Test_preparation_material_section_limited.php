...
class Test_preparation_material_section_limited extends REST_Controller {  
    ...
    { 
        if(!$this->Authenticate($this->input->get_request_header('API-KEY'))) {            
          ...
          $bData = $this->Test_preparation_material_model->getFreeResourceContentSpecificLimited($id);
