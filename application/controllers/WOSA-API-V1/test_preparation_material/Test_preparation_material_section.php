...
class Test_preparation_material_section extends REST_Controller {  
    ...
    { 
        if(!$this->Authenticate($this->input->get_request_header('API-KEY'))) {            
          ...
          $bData['basic']['content'] = $this->Test_preparation_material_model->getFreeResourceContentSpecific($id);
