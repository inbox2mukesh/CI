...
class Get_exam_list extends REST_Controller
{
    ...
    function index_get()
    {
		...
		$city	 = $this->input->get_request_header('city');
		...
		{
			$bData = $this->Purposes_master_model->getExamListActive($course,$program,$city);
            if(!empty($bData)) 
			{
