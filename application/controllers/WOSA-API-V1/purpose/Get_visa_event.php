...
class Get_visa_event extends REST_Controller
{
    ...
    function index_get()
    {
		...
		$event_int_country 	= $this->input->get_request_header('event-int-country');
		...
		{
			$bData = $this->Purposes_master_model->getVisaEventActive($event_int_country,$event_type,$division_id);
            if(!empty($bData)) 
			{
