...
class Get_inhouse_package extends REST_Controller
{
    ...
    function index_get()
    {
		...
		$branch  = $this->input->get_request_header('branch');
		...
		{
			$bData =  $this->Purposes_master_model->getInhousePackageActive($branch,$course,$program);
            if(!empty($bData)) 
			{
